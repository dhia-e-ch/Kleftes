...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/rIKQVYwX00)
...
```sh
npx nx serve kleftes-front
```

To create a production bundle:

```sh
npx nx build kleftes-front
```

To see all available targets to run for a project, run:

```sh
npx nx show project kleftes-front
```
